<?php
function recogerEquipo($idEquipo) {
    
    $archivo = "../view/assets/json/equipo".$idEquipo.".json"; // Nombre del archivo
    ...
    if (file_exists($archivo) && (time() - filemtime($archivo) < 86400)) {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://v3.football.api-sports.io/teams?id='.$idEquipo,
