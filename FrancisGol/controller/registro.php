<?php
    ...
    if (isset($_POST['registrarse'])) {
        ...
        $resultadoFormulario = $usuario->comprobarRegistro($_POST['email'],$_POST['nombre'] , $_POST['contrasenia'], $_POST['repetir_contrasenia']); // Comprobará si los datos son correctos y creará la cuenta
